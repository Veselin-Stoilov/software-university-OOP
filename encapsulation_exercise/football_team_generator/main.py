from encapsulation_exercise.football_team_generator.project.player import Player
from encapsulation_exercise.football_team_generator.project.team import Team
